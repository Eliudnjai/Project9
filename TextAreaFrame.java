...
public class TextAreaFrame extends JFrame 
{
   ...
   public TextAreaFrame() 
   {
      ...
      //Load text file from File.
      String words = "Load Text";
      fileLoadButton = new JButton(words); 
      c.gridx=0;
      c.gridy=1;
      box.add(fileLoadButton); // add copy button to box
      fileLoadButton.addActionListener(
